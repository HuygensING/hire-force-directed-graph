...
var _d3Browserify = _dereq_("d3-browserify");
...
function getGraph(json, filteredRelationTypes, graphNode) {
	...
	var svg = _d3Browserify2["default"].select(graphNode).append("svg:svg").attr("width", width).attr("height", height);
	...
	var force = _d3Browserify2["default"].layout.force().nodes(nodes).links(links).size([width, height]).linkDistance(linkDistance).charge(-800).on("tick", tick).start();
...
},{"d3-browserify":1}],4:[function(_dereq_,module,exports){
"use strict";
...
var css = Buffer("","base64");
